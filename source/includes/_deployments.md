...
```shell
curl "<%= curl_url %>/api/deployments/1" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl -XPOST "<%= curl_url %>/api/deployments"
  -H "Authorization: BEARER <%= curl_token %>"
...
```shell
curl -XPUT "<%= curl_url %>/api/deployments/:id"
  -H "Authorization: BEARER <%= curl_token %>"
  -H "Content-Type: application/json" \
  -d '{"deployment":{
    "name": "example",
...
```shell
curl -XDELETE "<%= curl_url %>/api/deployments/:id" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl "<%= curl_url %>/api/deployments/:deploymentId/versions" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl "<%= curl_url %>/api/deployments/:deploymentId/versions/:id" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl -XPOST "<%= curl_url %>/api/deployments/:deploymentId/versions"
  -H "Authorization: BEARER <%= curl_token %>"
  -H "Content-Type: application/json" \
  -d '{"version":{
    "version": "1.0",
...
```shell
curl -XPUT "<%= curl_url %>/api/deployments/:deploymentId/versions/:id"
  -H "Authorization: BEARER <%= curl_token %>"
  -H "Content-Type: application/json" \
  -d '{"deployment":{
    "name": "example",
...
```shell
curl -XDELETE "<%= curl_url %>/api/deployments/:deploymentId/versions/:id" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl "<%= curl_url %>/api/deployments/:deploymentId/versions/:id/files" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl "<%= curl_url %>/api/deployments/:deploymentId/versions/:id/files/:filepath" \
  -H "Authorization: BEARER <%= curl_token %>"
```
...
```shell
curl -XPOST "<%= curl_url %>/api/deployments/:deploymentId/versions/:id/files/config.ini"
  -H "Authorization: BEARER <%= curl_token %>"
  -F 'file=@filename'
```
...
```shell
curl -XDELETE "<%= curl_url %>/api/deployments/:deploymentId/versions/:id/files/:filepath" \
  -H "Authorization: BEARER <%= curl_token %>"
```
