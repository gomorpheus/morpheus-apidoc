...
This endpoint can be used to view dashboard information about the remote <%= application_name %> appliance.  This is an overview and summary of data available to the user that can be used to render a dashboard.
