...
These entities are incidents that result from [Checks](#monitor-checks)executed within the Morpheus system. The API provides a means to list all of an account's incidents and also update, mute, close, and reopen them.
